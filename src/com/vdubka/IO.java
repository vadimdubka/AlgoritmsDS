...
public final class IO {
    ...
    /**
     * Returns a new {@link Scanner} which reads from "input.txt".
     *
     * @return the scanner.
     */
    ...
    /**
     * Returns a new {@link Printer} which writes to "output.txt".
     *
     * @return the printer.
     */
    ...
    public static final class Scanner implements Closeable {
         ...
         *
         * @return the token.
         * @throws WrappedIOException if there is no token, or com.vdubka.IO error occurs.
         */
        public String next() {
            try {
